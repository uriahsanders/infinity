...
?>
   	<div id="workspace-sidebar">
   		...
   		<ul>
   			...
   			<br>
   			<li id="discover-id"data-ref="discover"class="workspace-main-li workspace-li-has-more active"><i class="fa fa-star fa-lg"></i>&emsp;Discover</li>
   			...
   			<li id="stream-id"data-ref="stream"class="workspace-main-li"><i class="fa fa-comments fa-lg"></i>&emsp;Stream</li>
   			<li id="control-id"data-ref="control"class="workspace-main-li"><i class="fa fa-dashboard fa-lg"></i>&emsp;Control</li>
   			<li id="members-id"data-ref="members"class="workspace-main-li"><i class="fa fa-users fa-lg"></i>&emsp;Members</li>
   			<li id="documents-id"data-ref="documents"class="workspace-main-li"><i class="fa fa-clipboard fa-lg"></i>&emsp;Documents</li>
   			<li id="tasks-id"data-ref="tasks"class="workspace-main-li"><i class="fa fa-tasks fa-lg"></i>&emsp;Tasks</li>
   			<li id="events-id"data-ref="events"class="workspace-main-li"><i class="fa fa-calendar fa-lg"></i>&emsp;Events</li>
   			<li id="graphs-id"data-ref="graphs"class="workspace-main-li"><i class="fa fa-bar-chart-o fa-lg"></i>&emsp;Graphs</li>
   			<li id="sketches-id"data-ref="sketches"class="workspace-main-li"><i class="fa fa-pencil fa-lg"></i>&emsp;Sketches</li>
   			<li id="files-id"data-ref="files"class="workspace-main-li"><i class="fa fa-file fa-lg"></i>&emsp;Files</li>
   			<li id="notes-id"data-ref="notes"class="workspace-main-li"><i class="fa fa-paperclip fa-lg"></i>&emsp;Notes</li>
   			<li id="suggestions-id"data-ref="suggestions"class="workspace-main-li"><i class="fa fa-question fa-lg"></i>&emsp;Suggestions</li>
   		</ul>
   	</div>
