...
<html xmlns="http://www.w3.org/1999/xhtml", id="html">
    ...
    break;
    case "redblack":
    echo '<link rel="stylesheet" type="text/css" href="/css/redblack.css" />';
    break;
    case "darkblue":
    echo '<link rel="stylesheet" type="text/css" href="/css/darkblue.css" />';
    break;
    case "whitebrown":
    echo '<link rel="stylesheet" type="text/css" href="/css/whitebrown.css" />';
    break;
    default:
    echo '<link rel="stylesheet" type="text/css" href="/css/dark.css" />';
    }
...
?>
    ...
    if(isset($_SESSION["IP"]) && $_SESSION["IP"] == getRealIp() && isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] == "YES" && isset($_SESSION["data"]) &&  $_SESSION["data"] == $_SERVER["HTTP_USER_AGENT"]) {
        ...
        echo '<div id="firststatus" style="position:absolute;top:8px;margin-left:35px;cursor:pointer;"><a><img class="status" src="/member/images/online.png" title="Online" onclick="$(\'#menu\').fadeToggle(\'slow\');" style="height:17px;"></a></div>';
        echo '<div id="menu" style="display:none;">';
        echo '<div style="position:absolute;top:6px;margin-left:58px;cursor:pointer;" onclick="changeStatus(\'/member/images/online.png\',\'Online\')"><a><img class="status" src="/member/images/online.png" title="Online" onclick="$(\'#menu\').fadeToggle(\'slow\');"></a></div>';
        echo '<div style="position:absolute;top:6px;margin-left:88px;cursor:pointer;" onclick="changeStatus(\'/images/reddot.png\',\'Busy\')"><a><img class="status" src="/images/reddot.png" title="Busy" onclick="$(\'#menu\').fadeToggle(\'slow\');" style="height:15.5px;width:12px;"></a></div>';
        echo '<div style="position:absolute;top:6px;margin-left:73px;cursor:pointer;" onclick="changeStatus(\'/images/yellowdot.png\',\'Away\')"><a><img class="status" src="/images/yellowdot.png" title="Away" onclick="$(\'#menu\').fadeToggle(\'slow\');"></a></div>';
        echo '<div style="position:absolute;top:6px;margin-left:103px;cursor:pointer;" onclick="changeStatus(\'/member/images/offline.png\',\'Invisible\')"><a><img class="status" src="/member/images/offline.png" title="Invisible" onclick="$(\'#menu\').fadeToggle(\'slow\');"></a></div>';
