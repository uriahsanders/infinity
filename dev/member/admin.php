...
function post_new() {
    ...
    }else if ($("#txt").val().length > 5000) {
        alert("You have to many characters");
    }else{
        $.ajax({
             type: "POST",
             url: "/cms/ajax_<?php echo $table; ?>.php",
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                if ($count > 0) {
                    ...
                    while($row2 = mysql_fetch_array($result2)) {
                        ...
                        echo "<a href=\"/user/".id2user($row2['by'], "id2user")."\">" . id2user($row2['by'], "id2screen") . "</a>\n";
                        echo "</td>\n";
                        echo "<td align=\"right\" colspan=\"2\" id=\"wall_tbl_rep_b".(($co==1)?"":"_f")."\">\n";
                        echo time_diff($row2['date']) . "\n";
                        echo "</td>\n";
                        echo "<td aligment=\"left\" width=\"135\">\n";
                        ...
                        echo "</td>\n";
                        echo "<td colspan=\"2\" width=\"800\" id=\"wall_tbl_rep_b\">\n";
                        $len = 300;
