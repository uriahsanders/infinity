...
<!--Your stuff here-->
   Statuses of Members: <span style="color:rgb(63, 98, 143);font-weight: bold;font-style:italic;">Project_Name</span> 
<br /><br />
<a onclick="$('#update').slideToggle('slow');">What are you doing right now?</a><br /><br />
