...
Boards for Project: <span style="color:rgb(63, 98, 143);font-weight: bold;font-style:italic;">Project_Name</span><br /><br />
<a href="#" onclick="$('#newdoc').slideToggle('slow');">New Document</a><br /><br />
<div style="display:none;" id="newdoc"><form><input name="title"type="text" placeholder="Title"/><br /><textarea name="document"style="height:200px;width:400px;"></textarea><br /><br /><input type="submit" value="Post" id="startplan" /></form></div>
<hr />
</div>
<!---->
<?php
