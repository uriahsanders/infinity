					...
					<div id="this-carousel-id" class="carousel slide">
					  <div class="carousel-inner">
					    <div class="item active">
					      <img src="images/26.jpg"style="width:100%;height:400px" class="slide-img"alt="" />
					      <div class="carousel-caption">
					        <p class="fa-lg"><br>Transforming dreams into reality</p>
					      </div>
					    </div>
					    <div class="item">
					      <img src="images/8.jpg"style="width:100%;height:400px" class="slide-img"alt="" />
					      <div class="carousel-caption">
					        <p class="fa-lg"><br>Transforming dreams into reality</p>
					      </div>
					    </div>
					    ...
					    <div class="item">
					      <img src="images/20.jpg"style="width:100%;height:400px" class="slide-img"alt="" />
					      <div class="carousel-caption">
					        <p class="fa-lg"><br>Transforming dreams into reality</p>
					      </div>
					    </div>
					    ...
					    <!-- <a class="carousel-control left" href="#this-carousel-id" data-slide="prev">
					    	...
					    	<br>
					    	<br>
					    	<i class="fa fa-toggle-left fa-4x"style="color:#000;"></i>
					    </a>
					    <a class="carousel-control right"href="#this-carousel-id" data-slide="next">
					    	...
					    	<br>
					    	<br>
					    	<i class="fa fa-toggle-right fa-4x"style="color:#000;"></i>
					    </a> -->
					</div>
			</div>
		</div>
		<div id="belt"><a class="fa fa-play-circle fa-3x black"></a></div>
		<br><br>
		<!-- Links to major points -->
		<div>
			<div id="main">
				...
				<div id="idea"class="panel panel-default yellow">
			        <div class="panel-heading">
			          <h3 class="panel-title lead yellow"><i class="fa fa-lightbulb-o fa-lg"></i> Come up with an idea.</h3>
			        </div>
			        <div class="panel-body lead yellow">
			          ...
			          <br><br>
			          <button class="btn"style="background:#cccc00">Launch Your Idea</button>
			        </div>
			    </div>
			    <br>
			    <div id="information"class="panel panel-default"style="color:#5cb85c">
			        <div class="panel-heading">
			          <h3 class="panel-title lead green"><i class="fa fa-globe fa-lg green"></i> Learn more about what you want to do.</h3>
			        </div>
			    ...
			    <br>
			    <div id="collaboration"class="panel panel-default"style="color:#3276b1">
			        <div class="panel-heading">
			          <h3 class="panel-title lead blue"><i class="fa fa-users fa-lg blue"></i> Find people to help you do it.</h3>
			        </div>
			        <div class="panel-body lead">
			    ...
			    <br>
			    <div id="freedom"class="panel panel-default"style="color:#d2322d">
			        <div class="panel-heading">
			          <h3 class="panel-title lead"style="color:#d2322d"><i class="fa fa-flag fa-lg red"></i> Take advantage of the freedom Infinity-Forum offers.</h3>
			        </div>
			        <div class="panel-body lead">
			    ...
			    <p class="lead">
					<h2 style="font-style:italic;color: #f0ad4e">
