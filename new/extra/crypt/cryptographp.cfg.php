...
$cryptheight = 30;   // Hauteur du cryptogramme (en pixels)

$bgR  = 199;         // Couleur du fond au format RGB: Red (0->255)
$bgG  = 199;         // Couleur du fond au format RGB: Green (0->255)
$bgB  = 199;         // Couleur du fond au format RGB: Blue (0->255)
//rgb(199, 199, 199)
