...
define("PAGE", "blog"); // this is what page it is, for the links at the top
...
?>
  ...
  <div style="background:url('/images/broken_noise.png');padding:100px;border:1px solid #000;width: 60%;margin:auto;font-size:2em">
    Coming soon!
  </div>
<?php
