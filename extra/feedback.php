...
/**
	[TODO] - fix so logged users saves data, see line 20-21
**/
if (isset($_POST['fee_l']) && isset($_POST['fee_n']) && isset($_POST['fee_f']) && isset($_POST['fee_a'])) {
	...
	if ($anon == 1) { // the user wants to be anonumous let him/her
			...
			$insert = $sql->Query("INSERT INTO feedback (`fee_l`,`fee_n`,`fee_f`,`fee_a`,`comments`,`date`) VALUES (?,?,?,?,?,?)",$_POST['fee_l'],$_POST['fee_n'],$_POST['fee_f'],$_POST['fee_a'],$comm, date("Y-m-d h:m:s"));
			if ($insert) 
